...
uint16_t VirtualDacImpl::init_sample(uint16_t buffer_size, uint32_t prescaler, uint32_t period, bool repeat)
{
}

void VirtualDacImpl::run()
{
}

void VirtualDacImpl::stop()
{
}
