...
void DAC::init_continious(uint16_t buffer_size, uint32_t prescaler, uint32_t period, uint16_t dma_chunk_size, uint16_t notify_when_left, OnInitDoneCallback on_init_done)
{
...
void DAC::init_sample(uint16_t buffer_size, uint32_t prescaler, uint32_t period, bool repeat, OnInitDoneCallback on_init_done)
{
...
void DAC::send_data(const std::vector<float>& data, OnDataSampleSet on_data_sample_set)
{
...
void DAC::add_continious_data_chunk(const std::vector<float>& data)
{
}


void DAC::run(OnRun callback)
{
...
void DAC::sock_setup_on_received_by_device(uint32_t id, bool success)
{
...
void DAC::sock_data_on_received(uint32_t id, bool success)
{
...
std::vector<uint16_t> DAC::prepare_to_send(const std::vector<float>& data)
{
